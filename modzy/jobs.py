...
class Jobs:
    ...
    def submit_netapp_storage_grid(self, model, version, sources, access_key_id, secret_access_key, endpoint, explain=False):
        ...
        Raises:
            ...
            Example:
                .. code-block::
                    ...
                    job = client.jobs.submit_netapp_storage_grid('model-identifier', '1.2.3',
                    {
                        'source-name-1': {
                            'model-input-name-1': {
                                'bucket': 'my-bucket',
