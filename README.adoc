...
and you can identify and refer to a specific input by the key that you assign, in the following code we are 
...
the output of the model, you need to check for the output key and format (in this case results.json).
